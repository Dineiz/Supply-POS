  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-surface px-4">
      <div className="w-full max-w-[22rem]">
              ...
              <div className="grid grid-cols-3 gap-2">
                {["1", "2", "3", "4", "5", "6", "7", "8", "9"].map((d) => (
                  <button
                    ...
                    disabled={loading}
                    className="h-14 w-14 rounded-md border border-border text-lg font-medium text-ink hover:bg-surface disabled:opacity-40"
                  >
                    {d}
                  </button>
                ))}
                ...
                <button
                  ...
                  className="h-14 w-14 rounded-md text-sm font-medium text-ink-muted hover:bg-surface disabled:opacity-40"
                >
                  ⌫
                </button>
              </div>
        ...
        <p className="mt-6 text-center text-xs text-ink-faint">Dineiz Supply · Warehouse &amp; Distribution</p>
      </div>
    </main>
  );
}
